...
class SuratTemplateCatalog
{
    public static function all()
    {
        return [
            ...
            [
                'id' => 'default-suket-perbaikan-presensi',
                'name' => 'Surat Keterangan Perbaikan Presensi',
                'slug' => 'surat-keterangan-perbaikan-presensi',
                'category' => 'Keterangan',
                'description' => 'Surat keterangan perbaikan catatan presensi dengan approval pimpinan satuan kerja.',
                'status' => 'active',
                'source_type' => 'system',
                'sample_file_path' => 'templates/surat-keterangan-perbaikan-presensi.docx',
                'surat_keluar_defaults' => [
                    'kategori_kode' => 'KP',
                    'nomenklatur_jabatan' => 'ketua',
                    'opsi_penerima' => 'internal',
