...
class LeaveRequestPolicy
{
    ...
    public function update(User $user, LeaveRequest $leaveRequest) { return ((int) $leaveRequest->user_id === (int) $user->id) && in_array($leaveRequest->status, [LeaveRequest::STATUS_DRAFT, LeaveRequest::STATUS_REJECTED], true) && !$leaveRequest->isLocked(); }
