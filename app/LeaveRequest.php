...
class LeaveRequest extends Model
{
    ...
    protected $casts = ['approver_chain_snapshot' => 'array','start_date' => 'date','end_date' => 'date','requested_days' => 'integer','approved_days' => 'integer','workday_count' => 'integer','needs_document_verification' => 'boolean','needs_ppk_approval' => 'boolean','is_deferred' => 'boolean','revision_number' => 'integer','submitted_at' => 'datetime','applicant_signature_size' => 'integer','verified_at' => 'datetime','approved_at' => 'datetime','rejected_at' => 'datetime','cancelled_at' => 'datetime','completed_at' => 'datetime','locked_at' => 'datetime'];
