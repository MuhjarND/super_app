        ...
        <div class="card">
            <div class="header">
                ...
                <div class="status {{ $verification['valid'] ? 'valid' : 'invalid' }}">
                    {{ $verification['valid'] ? 'Valid dan terverifikasi' : 'Tidak valid / belum final' }}
                </div>
            </div>
            <div class="body">
                <div class="grid">
                    <div class="item">
                        ...
                        <div class="value">{{ $verification['nomor'] }}</div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <div class="value">{{ $verification['judul'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Status Dokumen</span>
                        <div class="value">{{ $verification['status_label'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Penanda Tangan</span>
                        <div class="value">{{ $verification['signatory_name'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Jabatan Penanda Tangan</span>
                        <div class="value">{{ $verification['signatory_title'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Waktu Tanda Tangan</span>
                        <div class="value">{{ $verification['signed_at'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Dibuat Oleh</span>
                        <div class="value">{{ $verification['created_by'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Kategori Surat</span>
                        <div class="value">{{ $verification['kategori'] }}</div>
                    </div>
                    <div class="item">
                        <span class="label">Kode Verifikasi</span>
                        <div class="value">{{ $verification['token'] }}</div>
                    </div>
                </div>
