...
@php
    ...
    $canVerifyDocuments = $isApprovalMode && in_array($leaveApproval->role_name, ['verifikator_dokumen', 'ppk'], true);
...
{{-- Dokumen perlu diverifikasi terlebih dahulu pada halaman verifikator cuti. --}}
@if($isApprovalMode)
    @include('cuti.partials.documents-card')
@endif
