                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item['file_url'])
                                        <button
                                            type="button"
                                            class="badge badge-primary app-status-badge border-0"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="px-3 py-2 border-bottom bg-light d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" id="archivePreviewOpenNew" target="_blank" class="btn btn-sm btn-outline-primary">
